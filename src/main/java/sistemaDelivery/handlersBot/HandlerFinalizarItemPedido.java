...
public class HandlerFinalizarItemPedido extends HandlerBotDelivery {
    ...
    protected boolean runFirstTime(Message m) {
        ...
        builder.textNewLine(addOpcaoMenu(new HandlerRepetirUltimoItemPedido(chat), null, "Pedir mais um(a) " + getChatBotDelivery().getLastPedido().getProduto().getNomeWithCategories() + " igual", "Os adicionais escolhidos serão iguais").toString());
